...
<!-- Footer Start -->
<footer class="text-white text-center py-4" style="background-color: #FC8F54; width: 100%;">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <!-- Section: Map -->
            <div class="col-md-6 mb-0">
                <h5 class="mb-3">Lokasi Wisata Desa Pampang</h5>
                <iframe 
            ...
            <div class="col-md-6 mb-0 d-flex flex-column align-items-center justify-content-center ps-md-5">
                ...
                <div class="d-flex flex-column align-items-start">
                    <a href="#" class="text-decoration-none mb-2 social-icon d-flex align-items-center">
                        <i class="fab fa-facebook-f" style="font-size: 18px; color: white;"></i>
                        <span class="text-white ms-2">Facebook</span>
                    </a>
                    <a href="#" class="text-decoration-none mb-2 social-icon d-flex align-items-center">
                        <i class="fab fa-twitter" style="font-size: 18px; color: white;"></i>
                        <span class="text-white ms-2">Twitter</span>
                    </a>
                    <a href="#" class="text-decoration-none mb-2 social-icon d-flex align-items-center">
                        <i class="fab fa-youtube" style="font-size: 18px; color: white;"></i>
                        <span class="text-white ms-2">YouTube</span>
                    </a>
                    <a href="#" class="text-decoration-none mb-2 social-icon d-flex align-items-center">
                        <i class="fab fa-instagram" style="font-size: 18px; color: white;"></i>
                        <span class="text-white ms-2">Instagram</span>
                    </a>
                    <a href="https://wa.me/1234567890" class="text-decoration-none mb-2 social-icon d-flex align-items-center">
                        ...
                        <span class="text-white ms-2">WhatsApp</span>
                    </a>
                </div>
            </div>
        </div>
